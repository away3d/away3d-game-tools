...
package agt.debug {
	...
	public class SimpleGUI extends EventDispatcher {
		...
		private static const OFFSETX : int = 1;
		...
		private function initStyles() : void {
			Style.PANEL = 0xfc6a11;
			Style.BACKGROUND = 0xfc6a11;
		...
		private function initToolbar() : void {
			...
			_toggle.graphics.beginFill(Style.BACKGROUND, 0.9);
