...
public class LiveEntity
{
	...
	public var collideStrength:Number = 100; // force strength exerted on dynamic objects

	public function LiveEntity(mesh:Mesh, capsuleRadius:Number, capsuleHeight:Number)
	{
	...
	private function initEntity():void
	{
		...
		var ghost:AWPGhostObject = new AWPGhostObject(entityShape, new Away3DMesh(_mesh, new Vector3D(0, -65, 20)));
