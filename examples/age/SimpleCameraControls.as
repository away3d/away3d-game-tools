package {
	...
	public class SimpleCameraControls extends Sprite {
		...
		private function enterframeHandler(evt : Event) : void {
			...
			// update gui stuff
			_positionLabel.text = "position: " + roundValue(view.camera.x) + ", " + roundValue(view.camera.y) + ", " + roundValue(view.camera.z);
			_orientationLabel.text = "orientation: " + roundValue(view.camera.rotationX) + ", " + roundValue(view.camera.rotationY) + ", " + roundValue(view.camera.rotationZ);
		}
		...
		private function initGui() : void {
			...
			var cameraModes : Array = [{label:"orbit", data:"orbit"}, {label:"free fly", data:"fly"}];
